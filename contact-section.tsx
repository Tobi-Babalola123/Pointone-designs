  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div
          className={`absolute right-4 lg:right-8 top-1/2 space-y-3 lg:space-y-4 transition-all duration-1000 delay-400 ${
        ...
        >
          {[0, 1, 2, 3, 4].map((i) => (
            <div
              ...
              className={`${
                i === 4
                  ? "w-3 h-3 lg:w-4 lg:h-4 border-2 border-white"
                  : "w-2 h-2 lg:w-3 lg:h-3 bg-white"
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 pt-8 lg:pt-16">
        <div className="max-w-4xl mx-auto text-center">
          {/* Header */}
          <div
            className={`space-y-4 lg:space-y-6 mb-12 lg:mb-16 transition-all duration-1000 delay-200 ${
              isVisible
          ...
          >
            ...
            <p
              className={`text-gray-700 text-base lg:text-lg font-montserrat leading-relaxed max-w-2xl mx-auto transition-all duration-1000 delay-300 ${
                isVisible
                  ? "translate-y-0 opacity-100"
                  : "translate-y-5 opacity-0"
              }`}
            >
              Have an exciting project in mind? Let's discuss how we can bring
          ...
          <form onSubmit={handleSubmit} className="space-y-8 lg:space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
              ...
              >
                <label
                  htmlFor="name"
                  className="block text-left text-gray-600 text-sm font-medium font-montserrat"
                >
                  Your Name
                </label>
            ...
            {/* Submit Button */}
            <div
              className={`pt-4 lg:pt-8 transition-all duration-1000 delay-700 ${
                isVisible
                  ? "translate-y-0 opacity-100"
                  : "translate-y-10 opacity-0"
              }`}
