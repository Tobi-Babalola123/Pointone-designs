...
export default function HeroSection() {
  ...
  >
    <div className="px-4 sm:px-6 lg:px-0">
      <h1 className="text-4xl sm:text-5xl lg:ml-20 lg:text-6xl xl:text-7xl font-bold font-poppins text-lime-400 leading-tight">
        <span className="inline-block hover:scale-105 transition-transform duration-300">Frontend</span>
        <br />
  ...
  <div className="col-span-full lg:col-span-6">
    <div className="relative group w-72 h-80 sm:w-80 sm:h-96 lg:w-96 lg:h-[28rem] mx-auto">
      ...
      <div className="absolute inset-0 bg-white/30 backdrop-blur-md border border-white/20 rounded-3xl shadow-xl transition-transform duration-500 group-hover:scale-105 z-10" />

      {/* Profile Image */}
      <div className="relative w-full h-full overflow-hidden rounded-3xl z-20">
        <Image
          src="/tobi.webp?height=500&width=450"
      ...
      <div className="absolute inset-0 rounded-3xl border-2 border-transparent group-hover:border-lime-300 transition-all duration-500 z-30 pointer-events-none" />
    </div>
  </div>
</div>
